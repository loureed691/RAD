...
def test_very_small_balance_config():
    ...
    try:
        ...
        assert Config.LEVERAGE == 4, f"Expected leverage 4, got {Config.LEVERAGE}"
        ...
        assert Config.LEVERAGE == 4, f"Expected leverage 4 for <$100, got {Config.LEVERAGE}"
        ...
        assert Config.LEVERAGE == 6, f"Expected leverage 6 for $100, got {Config.LEVERAGE}"
...
def test_position_sizing_small_balances():
    ...
    try:
        ...
        # Test edge case: stop loss equals entry (should return 0 as no risk)
        ...
        print(f"  ✓ Zero distance handled: Position size = {size:.6f} contracts (returns 0 as expected)")
