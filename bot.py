...
class TradingBot:
    ...
    def __init__(self):
        ...
        self.logger.info("📝 Unified logging configuration:")
        ...
        self.logger.info("   Component tags: [POSITION], [SCANNING], [ORDER], [STRATEGY]")
        self.logger.info("   All logs consolidated for better visibility")
